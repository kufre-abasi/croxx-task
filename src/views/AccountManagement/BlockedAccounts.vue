...
import DataTable from '@/components/ui/AccountManagement/BlockedAccounts/DataTable.vue';
...
const rows = ref([
{
    id: '1',
    name: 'Peter Abutu',
    email: 'ajidagba26@yopmail.com',
    note: 'No note',
    accountNo: '1234567801',
    sortCode: '123456',
    dateBlocked: '2023-02-19 12:28:16',
  },
  {
    id: '2',
    name: 'Abdur-rasheed Idris',
    email: 'ajidagba26@yopmail.com',
    note: 'No note',
    accountNo: '1234567801',
    sortCode: '123456',
  ...
  <main>
    ...
    <div class="lg:px-6 px-3  pt-8 grid grid-rows gap-4">
        ...
        <div class="flex lg:flex-row flex-col gap-3 px-4 justify-between mb-4">
            <h3 class="font-Satoshi500 text-[24px] place-self-center leading-[32.4px] text-[#001727]">Blocked Accounts</h3>
            ...
            <DataTable class="bg-white mx-4" :columns="columns" :rows="rows" />
    </div>
