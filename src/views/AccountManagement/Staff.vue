...
import DataTable from '@/components/ui/AccountManagement/Staff/DataTable.vue';
  ...
  <main>
    ...
    <div class="lg:px-6 px-3  pt-8 grid grid-rows gap-4">
        ...
        <div class="flex lg:flex-row flex-col gap-3 px-4 justify-between mb-4">
            <h3 class="font-Satoshi500 text-[24px] place-self-center leading-[32.4px] text-[#001727]">Staff</h3>
