...
import DataTable from '@/components/ui/Marketing/Invoice/DataTable.vue';
const columns = ref([
  'Name',
  'Status',
  'Created',
      ...
      <div class="lg:px-6 px-3  pt-8 grid grid-rows gap-4">
          <div class="bg-white  py-8 rounded-[8px] min-h-[100vh] relative px-2">
            <div class="flex lg:flex-row flex-col gap-3 px-4 justify-between mb-4">
                <h3 class="font-Satoshi500 text-[24px] place-self-center leading-[32.4px] text-[#001727]">Invoice</h3>
